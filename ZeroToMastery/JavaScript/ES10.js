...
const updatedUsers = Object.fromEntries(updatedUsersArray); // {user1: 36546, user2: 185666, user3: 180630}

Object.fromEntries(Object.entries(users).map(([key, val]) => [key, val * 2]));
